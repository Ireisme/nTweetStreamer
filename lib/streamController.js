...
controller.allRunning = function(){
	var running = _.filter(controller.processes, function(process){ return process.streamId !== ""; });
	return _.map(running, function(process){ return process.streamId; });
};
